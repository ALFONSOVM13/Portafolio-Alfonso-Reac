...
const Education = () => {
    ...
    return (
      ...
      <div className="d-flex justify-content-center mb-3">
        ...
        >
          <FaGraduationCap className="mr-2" size={24} color={activeTab === "tab1" ? "#ffffff" : "#000000"} />
          Educación
        </button>
        <button
        ...
        >
          <TbCertificate className="mr-2" size={24} color={activeTab === "tab2" ? "#ffffff" : "#000000"} />
        ...
        {activeTab === "tab2" && (
          <>
            <div className="col-md-4 mb-4">
              <div className="card">
                <div className="card-body">
                  <h4>COURSERA<br />University of Colorado System</h4>
                  <p style={{ textAlign: "center" }}>Año 2022</p>
                  <h5>Design and Build a Data Warehouse for Business Intelligence Implementation</h5>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="card">
                <div className="card-body">
                  <h4>COURSERA <br/>University of Colorado System</h4>
                  <p style={{ textAlign: "center" }}>Año 2022</p>
                  <h5>Business Intelligence Concepts, Tools, and Applications</h5>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="card">
                <div className="card-body">
                  <h4>SCRUM STUDY<br/>Scrum Fundamentals</h4>
